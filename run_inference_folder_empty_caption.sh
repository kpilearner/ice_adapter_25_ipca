...
# Batch inference for a folder of images (adapter caption forced to empty).
# Usage: ./run_inference_folder_empty_caption.sh
...
OUTPUT_DIR="./msrs_adapter_empty_caption"
...
python scripts/inference_folder_empty_caption.py \
  --input-dir "${INPUT_DIR}" \
