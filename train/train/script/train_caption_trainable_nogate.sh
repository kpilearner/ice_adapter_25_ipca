...
# usage: ./train_caption_trainable_nogate.sh [CONFIG_FILE] [PORT]
# example: ./train_caption_trainable_nogate.sh paired_csv_lora_caption_trainable_nogate.yaml 41353

set -euo pipefail

CONFIG_FILE="${1:-paired_csv_lora_caption_trainable_nogate.yaml}"
PORT="${2:-41353}"
