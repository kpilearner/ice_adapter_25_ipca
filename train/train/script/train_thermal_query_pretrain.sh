...
# usage: ./train_thermal_query_pretrain.sh [CONFIG_FILE] [PORT]
# example: ./train_thermal_query_pretrain.sh paired_csv_thermal_query_pretrain.yaml 41353

set -euo pipefail

CONFIG_FILE="${1:-paired_csv_thermal_query_pretrain.yaml}"
PORT="${2:-41353}"
