...
# usage: ./train_caption_trainable.sh [CONFIG_FILE] [PORT]
# example: ./train_caption_trainable.sh paired_csv_lora_caption_trainable.yaml 41353

set -euo pipefail

CONFIG_FILE="${1:-paired_csv_lora_caption_trainable.yaml}"
PORT="${2:-41353}"
