...
# usage: ./train_thermal_gate_headwise.sh [CONFIG_FILE] [PORT]
# example: ./train_thermal_gate_headwise.sh paired_csv_lora_thermal_gate_headwise.yaml 41353

set -euo pipefail

CONFIG_FILE="${1:-paired_csv_lora_thermal_gate_headwise.yaml}"
PORT="${2:-41353}"
