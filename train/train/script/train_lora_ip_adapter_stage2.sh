...
# usage: ./train_lora_ip_adapter_stage2.sh [CONFIG_FILE] [PORT]
# example: ./train_lora_ip_adapter_stage2.sh paired_csv_lora_ip_adapter_stage2.yaml 41353

set -euo pipefail

CONFIG_FILE="${1:-paired_csv_lora_ip_adapter_stage2.yaml}"
PORT="${2:-41353}"
