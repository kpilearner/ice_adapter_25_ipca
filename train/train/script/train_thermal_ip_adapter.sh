...
# usage: ./train_thermal_ip_adapter.sh [CONFIG_FILE] [PORT]
# example: ./train_thermal_ip_adapter.sh paired_csv_lora_thermal_ip_adapter.yaml 41353

set -euo pipefail

CONFIG_FILE="${1:-paired_csv_lora_thermal_ip_adapter.yaml}"
PORT="${2:-41353}"
