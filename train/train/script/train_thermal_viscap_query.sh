...
# usage: ./train_thermal_viscap_query.sh [CONFIG_FILE] [PORT]
# example: ./train_thermal_viscap_query.sh paired_csv_lora_thermal_viscap_query.yaml 41353

set -euo pipefail

CONFIG_FILE="${1:-paired_csv_lora_thermal_viscap_query.yaml}"
PORT="${2:-41353}"
