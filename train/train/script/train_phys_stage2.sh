...
# Stage-2: physical/brightness LoRA training
# usage: ./train_phys_stage2.sh [CONFIG_FILE] [PORT]
# example: ./train_phys_stage2.sh paired_csv_lora_phys_stage2.yaml 41353

set -euo pipefail

CONFIG_FILE="${1:-paired_csv_lora_phys_stage2.yaml}"
PORT="${2:-41353}"
