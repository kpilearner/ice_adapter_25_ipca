...
# usage: ./train_caption_gate_global.sh [CONFIG_FILE] [PORT]
# example: ./train_caption_gate_global.sh paired_csv_lora_caption_gate_global.yaml 41353

set -euo pipefail

CONFIG_FILE="${1:-paired_csv_lora_caption_gate_global.yaml}"
PORT="${2:-41353}"
