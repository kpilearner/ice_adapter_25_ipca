...
# Stage-1: LoRA + text token adapter training
# usage: ./train_text_stage1.sh [CONFIG_FILE] [PORT]
# example: ./train_text_stage1.sh paired_csv_lora_text_stage1.yaml 41353

set -euo pipefail

CONFIG_FILE="${1:-paired_csv_lora_text_stage1.yaml}"
PORT="${2:-41353}"
